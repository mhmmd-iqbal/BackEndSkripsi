<div class="wrapper-page">
    ...
    <table border="1px" width = "100%" style="border-collapse: collapse; padding-top: 10px" class="main-table">
        ...
        <tr>
            <td colspan="2" width="80%" style="text-align: center">
                <div class="label-size">
                    FORM BORANG AUDIT AKADEMIK INTERNAL
                </div>    
                <div class="label-size">
                    PROGRAM STUDI
                </div>
    ...
    <table  border="1px" width = "100%" style="border-collapse: collapse; padding-top: 10px" class="main-table">
        ...
        <tr>
            <td class="main-size" style="text-align: center"></td>
            <td class="main-size" style="text-align: center" colspan="2"></td>
            <td class="main-size" style="text-align: center" colspan="2"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="main-size" style="text-align: center" colspan="2"></td>
            <td class="main-size" style="text-align: center" colspan="3"></td>
        </tr>
        <tr>
    ...
    <table  border="1px" width = "100%" style="border-collapse: collapse; padding-top: 10px" class="main-table">
        ...
        <tr>
            <th class="label-size" style="text-align: center">1 </th>
            <th class="label-size" style="text-align: center">Topik </th>
            <th class="label-size" style="text-align: center">Sub Topik </th>
            <th class="label-size" style="text-align: center"> </th>
            <th class="label-size" style="text-align: center"></th>
        </tr>
    </table>
</div>