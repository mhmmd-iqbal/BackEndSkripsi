...
<div class="wrapper-page">
    ...
    <table  border="1px" width = "100%" style="border-collapse: collapse; padding-top: 10px" class="main-table">
        ...
        <tr>
            ...
            <td style="text-align: left; padding-left: 5px" class="main-size">{{$reject->department->major->name}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="text-align: left; padding-left: 5px" class="main-size">{{$reject->auditee_name}}</td>
        </tr>
    </table>
