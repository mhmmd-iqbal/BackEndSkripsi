    ...
    <table border="1px" width = "100%" style="border-collapse: collapse; padding-top: 10px" class="main-table">
        ...
        <tr>
            <td colspan="2" width="80%" style="text-align: center">
                <div class="label-size">
                    FORM BORANG AUDIT MUTU INTERNAL
                </div>
                <div class="label-size">
                    PROGRAM STUDI
                </div>
                <div class="label-size">
                    Deskripsi Temuan Audit dan 
                </div>
                <div class="label-size">
    ...
    <table  border="1px" width = "100%" style="border-collapse: collapse; padding-top: 10px" class="main-table">
        ...
        <tr>
            <th style="text-align: left; padding-left: 5px" class="label-size">Jurusan</th>
            <td style="text-align: left; padding-left: 5px" class="main-size"></td>
        </tr>
        <tr>
            <th style="text-align: left; padding-left: 5px" class="label-size">Program Studi</th>
            <td style="text-align: left; padding-left: 5px" class="main-size"></td>
        </tr>
        <tr>
            <th style="text-align: left; padding-left: 5px" class="label-size">Ketua Program Studi</th>
            <td style="text-align: left; padding-left: 5px" class="main-size"></td>
        </tr>
    </table>
    ...
    <table  border="1px" width = "100%" style="border-collapse: collapse; padding-top: 10px" class="main-table">
        ...
        <tr>
            <td style="text-align: left; padding-left: 5px" class="main-size" height="30px" valign="middle" colspan="2">-</td>
        </tr>
        <tr>
    ...
    <table  border="1px" width = "100%" style="border-collapse: collapse; padding-top: 10px" class="main-table">
        ...
        <tr>
            <td style="text-align: left; padding-left: 5px" height="30px" class="main-size"></td>
            <td style="text-align: left; padding-left: 5px" height="30px" class="main-size"></td>
            <td style="text-align: left; padding-left: 5px" height="30px" class="main-size"></td>
        </tr>
    </table>
