<div class="wrapper-page">
    ...
    <table style="border-collapse: collapse" border="1px" width="100%">
        <tr>
            <th class="label-size" width="20%" style="text-align: left; padding-left: 5px">Unit Penunjang</th>
        ...
        <tr>
            <th class="label-size" width="20%" style="text-align: left; padding-left: 5px">Auditee</th>
